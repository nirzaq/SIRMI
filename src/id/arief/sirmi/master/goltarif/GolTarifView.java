 ...
 * @author arief-asus
 */
public class GolTarifView extends javax.swing.JInternalFrame {
    
    GolTarifTableModel tableModel = new GolTarifTableModel();
    GolTarifController controller = new GolTarifController();
    GolTarifTambahUbah tambahUbah = new GolTarifTambahUbah();
    ...
    private void initComponents() {
        ...
        comboCari.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Gol Tarif", "Tarif", "Jenis Tarif" }));
    ...
    private void textCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textCariKeyReleased
        try {
            ...
            List<GolTarif> list = controller
                    .getDataByParameter(sqlParameter, searchParameter);
            tableModel.setData(list);
        } catch (Exception error) {
            
            System.out.println("Terjadi kesalahan textCariKeyReleased  : \n& " + error);
    ...
    private void buttonHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonHapusActionPerformed
        int confirm = MessageUtil.
                showConfirmMessage("Apakah anda ingin menghapus tarif dengan golongan " + textNopol.getText() + " ?", this);
    ...
    public void tableMobilAction() {
        tableData
            ...
            if (row != -1) {
                GolTarif golTarif = tableModel.get(row);
                ...
                //set textNopol
                //textNopol.setText(.getNopol_mobil());
    ...
    public void loadDatabase() {
        try {
            List<GolTarif> list = controller.getData();
            tableModel.setData(list);
        } catch (Exception error) {
            System.out.println("Terjadi kesalahan loadDatabase : \n& " + error);
            JOptionPane.showMessageDialog(this, "Terjadi kesalahan : ");
        }
    }
    ...
    private void refresh() {
        ...
        loadDatabase();
        //Disable Button
        GolTarifTambahUbah.buttonSimpan.setEnabled(false);
        textCari.setText("");
