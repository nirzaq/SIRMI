...
public class TarifView extends javax.swing.JInternalFrame {
    ...
    TarifTambahUbah tambahUbah = new TarifTambahUbah();
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        TableUtil.kolomRataTengah(tableData, 2);
    ...
    private void buttonTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonTambahActionPerformed
        ...
        TarifTambahUbah.labelTitle.setText("TAMBAH TARIF");
        ViewUtil.showForm(desktopPaneUtama, this, tambahUbah);
        TarifTambahUbah.clearField();
        
    }//GEN-LAST:event_buttonTambahActionPerformed

    private void buttonUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonUbahActionPerformed
        MobilTambahUbah.labelTitleTambahUbahMobil.setText("UBAH TARIF");
        ViewUtil.showForm(desktopPaneUtama, this, tambahUbah);
    ...
    private void textCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textCariKeyReleased
        try {
            ...
            List<Tarif> list = controller.getDataByParameter(sqlParameter, searchParameter);
    ...
    private void buttonHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonHapusActionPerformed
        int confirm = MessageUtil.
                showConfirmMessage("Apakah anda ingin menghapus tarif mobil dengan nopol " + textNopol.getText() + " ?", this);
    ...
    public void tableMobilAction() {
        tableData
            ...
            if (row != -1) {
                ...
                Tarif tarif = tableModel.get(row);
                ...
                TarifTambahUbah.textKodeMobil.setText(tarif.getKode_mobil());
                TarifTambahUbah.textGolonganTarif.setText(tarif.getGol_tarif());        
            }
        });
    }
    ...
    public void loadDatabase() {
        try {
            List<Tarif> list = controller.getData();
            tableModel.setData(list);
        } catch (Exception error) {
            System.out.println("Terjadi kesalahan : \n& " + error);
            JOptionPane.showMessageDialog(this, "Terjadi kesalahan : ");
    ...
    private void refresh() {
        ...
        loadDatabase();
        //Disable Button
        TarifTambahUbah.buttonSimpan.setEnabled(false);
        textCari.setText("");
